...
class TestShowKeyInRepresentation(expecttest.TestCase):
    ...
    def test_find_index_of_instruction_causing_hidden_key_succeedsWhenCausedByTraverse(
        self,
    ):
        u = AtomicNode("u")
        v = AtomicNode("v")
        ...
        self.assertEqual(
            find_index_of_instruction_causing_hidden_key(c, representation), 1
        )

    def test_find_index_of_instruction_causing_hidden_key_succeedsWhenCausedByExpand(
        self,
    ):
        u = AtomicNode("u")
        v = AtomicNode("v")
    ...
    def test_find_index_of_instruction_causing_hidden_key_findsFirstSuchInstruction(
        self,
    ):
        u = AtomicNode("u")
        v = AtomicNode("v")
    ...
    def test_find_index_of_instruction_causing_hidden_key_returnsNoneIfNoSuchInstruction(
        self,
    ):
        u = AtomicNode("u")
        v = AtomicNode("v")
        ...
        representation = [StartTraversal([a]), Traverse(mapping), EndTraversal([b])]
        self.assertIsNone(
            find_index_of_instruction_causing_hidden_key(c, representation)
        )

    def test_show_key_in_representation_segment_successfullyShowsKeyWhenOffendingIsTraverse(
        self,
    ):
        u = AtomicNode("u")
        v = AtomicNode("v")
        ...
        self.assertExpectedInline(
            str(result),
            """[STT <[a, c_1]>, TRV <u;w ---> v;w, []>, TRV <v;w ---> w, []>, ENT <[c]>]""",
        )
        self.assertEqual(idx, 3)

    def test_show_key_in_representation_segment_successfullyShowsKeyWhenOffendingIsExpandAndExpandHasOnlyOneHiddenKey(
        self,
    ):
        u = AtomicNode("u")
        v = AtomicNode("v")
        ...
        result, idx = show_key_in_representation_segment(c_1, representation)
        self.assertExpectedInline(
            str(result), """[STT <[a, c_1]>, TRV <u;w ---> v;w, []>, ENT <[b, c]>]"""
        )
        self.assertEqual(idx, 3)

    def test_show_key_in_representation_segment_successfullyShowsKeyWhenOffendingIsExpandAndExpandHasMultipleHiddenKeys(
        self,
    ):
        u = AtomicNode("u")
        v = AtomicNode("v")
        ...
        self.assertExpectedInline(
            str(result),
            """[STT <[a, c_1]>, TRV <u;w ---> v;w, []>, EXP <v;w, v;w;x, [0, 1], [d_1]>, ENT <[b, c, d]>]""",
        )
    ...
    def test_show_key_in_representation_segment_onlyOperatesOnFirstSuchSegment(self):
        ...
        self.assertExpectedInline(
            str(result),
            """[STT <[a, c_1]>, TRV <u;w ---> v;w, []>, TRV <v;w ---> w, []>, ENT <[c]>, STT <[a]>, TRV <u ---> v, []>, EXP <v, v;w, [0], [c_1]>, ENT <[b, c]>]""",
        )

    def test_show_key_in_representation_segment_doesNotAffectEarlierSegmentsWithNoKey(
        self,
    ):
        u = AtomicNode("u")
        v = AtomicNode("v")
    ...
    def test_show_key_in_representation_segment_isIdentityIfKeyNotInSequence(self):
        ...
        result, idx = show_key_in_representation_segment(c_1, representation)
        self.assertExpectedInline(
            str(result), """[STT <[a]>, TRV <u ---> v, []>, ENT <[b]>]"""
        )
    ...
    def test_show_key_in_representation_operatesOnAllSegments(self):
        ...
        self.assertExpectedInline(
            str(result),
            """[STT <[a, c_1]>, TRV <u;w ---> v;w, []>, TRV <v;w ---> w, []>, ENT <[c]>, STT <[a, c_1]>, TRV <u;w ---> v;w, []>, ENT <[b, c]>]""",
        )
