...
""",
    ...
    def test3(self):
        ...
        t3 = t2.mutate(volume_fillna=t2["volume"].extend(0)).sort(["FromCity", "ToCity"])
        self.assertExpectedInline(
            str(t3),
            """\
...
ToCity                                             ...                                                   
London     [Cambridge, Oxford, Edinburgh, London]  ...  [0.45454545454545453, 0.1818181818181818, 0.36...
...
FromCity  ToCity                                                              
Cambridge London        3.0  [0.45454545454545453, 0.1818181818181818, 0.36...
...
Oxford    London        1.2  [0.45454545454545453, 0.1818181818181818, 0.36...
          Edinburgh     1.8  [0.5714285714285714, 0.42857142857142855, 0.0,...
Edinburgh Cambridge     1.8                [0.0, 0.0, 0.3, 0.7000000000000001]
          London        2.4  [0.45454545454545453, 0.1818181818181818, 0.36...
Cambridge Cambridge     NaN                [0.0, 0.0, 0.3, 0.7000000000000001]
London    London        NaN  [0.45454545454545453, 0.1818181818181818, 0.36...
          Edinburgh     NaN  [0.5714285714285714, 0.42857142857142855, 0.0,...
Oxford    Cambridge     NaN                [0.0, 0.0, 0.3, 0.7000000000000001]
          Oxford        NaN  [0.19999999999999998, 0.0, 0.0, 0.799999999999...
Edinburgh Oxford        NaN  [0.19999999999999998, 0.0, 0.0, 0.799999999999...
          Edinburgh     NaN  [0.5714285714285714, 0.42857142857142855, 0.0,...
...
""",
    ...
    def test11(self):
        ...
        t10 = t9.mutate(total_outflow=t9["volume_fillna"].sum())
        t11 = t10.mutate(
            relative_outflow=t10["volume_fillna"] / t10["total_outflow"]
        )
        self.assertExpectedInline(
            str(t11),
            """\
...
""",
    ...
    def test14(self):
        ...
        t5 = t4.shift_left()
        t6 = t5.mutate(
            relative_inflow = t5["volume_fillna"] / t5["volume_fillna"].sum()
        )

        t7 = t3.shift_left()
        t8 = t7.mutate(
            relative_outflow = t7["volume_fillna"] / t7["volume_fillna"].sum()
        )
