...
class TestEx3(expecttest.TestCase):
    def test_ex3(self):
        ...
        t1 = s.get([SchemaNode("Val_id"), SchemaNode("Cardnum")])
        ...
        t2 = t1.infer(["Val_id, Cardnum"], SchemaNode("bonus", cluster="bonus"))
        ...
        t4 = t3.filter(lambda r: r["bonus.bonus"] is not np.NAN)
        # [Val_id Cardnum || bonus.bonus  tstart.tstart]
        #  1      5172    || 4            2023-01-01 09:50:00
        #  1      1410    || 12           2023-01-01 09:50:00
        ...
        t6 = t5.filter(t4["Cardnum"] == t4["cardnum.cardnum"])
        # [Val_id Cardnum || bonus.bonus  tstart.tstart            cardnum.cardnum]
        #  1      5172    || 4            2023-01-01 09:50:00      5172
        ...
        t12 = (t11.infer("Val_id", c_cardnum)
               .infer("Val_id", t_tstart)
               .infer("Val_id", SchemaNode("bonus", cluster="bonus"))
               )
